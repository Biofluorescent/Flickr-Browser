...
class Photo(var title: String, var author: String, var authorId: String, var link: String, var tags: String, var image: String): Serializable {
    ...
    //These 3 functions are needed to tell how data should be de/serialized
    // Kotlin equivalent of a java signature the function needs
    ...
    // Intended for rare cases when you've created a subclass of the class that was originally serialized
